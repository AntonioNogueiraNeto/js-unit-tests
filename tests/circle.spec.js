...
describe('4 - Implemente os casos de teste para a função `circle`', () => {
  it('Verifica se ao receber um raio, a função `circle` retorna um objeto contendo os valores esperados', () => {
    ...
    expect(circle('Palavra')).toBe(undefined)
  });
    ...
    //refatorando com ajuda da galera do discorde, deixando mais facil pois havia esquecido do area
...
//https://app.betrybe.com/course/live-lectures/sd-cohort-24-a